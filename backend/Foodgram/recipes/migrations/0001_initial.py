# Generated by Django 3.2.16 on 2022-11-29 19:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reciepe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='recipes.recipe')),
        ...
        migrations.AddField(
            model_name='recipe',
            name='tags',
            field=models.ManyToManyField(through='recipes.TagReciepe', to='recipes.Tag', verbose_name='Список тегов'),
        ),
    ]
